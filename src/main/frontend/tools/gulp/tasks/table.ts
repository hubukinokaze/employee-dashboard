...
/** Path to tsconfig file for the employee-dashboard. */
...
/** Builds components for employee-dashboard releases */
...
/** Creates a rollup bundles of the employee-dashboard components.*/
